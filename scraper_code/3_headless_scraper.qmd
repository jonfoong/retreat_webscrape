...
timezone <- ses$findElement('#new_timezone > option:nth-child(318)')
...
set_timezone <- ses$findElement("#new_timezone_selected")
...
click_sidebar <- ses$findElement('#left_panel_menu_column > ul:nth-child(1) > li:nth-child(8) > a')
...
click_sidebar <- ses$findElement("#home > div.ui-panel-wrapper > div.ui-content.ui-body-a > div.undefined > div > ul > li:nth-child(4) > a")
